...
"settings":
{
	...
	"redirect_settings" : 
	{
		...
		"gotopage" : "http://www.monocromatica.mx",
...
"rules":{"nombre":{"label":"Nombre","fieldtype":"text","required":true,"messages":"Por favor inserta tu nombre"},"apellido":{"label":"Apellido","fieldtype":"text","required":true,"messages":"Por favor inserta tu nombre"},"email":{"email":true,"label":"Email","fieldtype":"email","required":true,"messages":"Por favor inserta un correo de email v&aacute;lido"},"telefono":{"label":"Tel&eacute;fono","fieldtype":"text"},"direccion":{"label":"Direcci&oacute;n","fieldtype":"text"},"ciudad":{"label":"Ciudad","fieldtype":"text","required":true},"estado":{"label":"Estado","fieldtype":"text","required":true},"pais":{"label":"Pa&iacute;s","fieldtype":"text","required":true},"zis":{"fieldtype":"text","label":"Codigo Postal"},"terminos":{"checkbox":true,"number_required":1,"label":"T&eacute;rminos y condiciones de uso","fieldtype":"checkbox","required":true,"values":["Acepto los teminos y condiciones de uso"]}},
"payment_rules":{"terminos":{}},
"conditional_rules":{},
